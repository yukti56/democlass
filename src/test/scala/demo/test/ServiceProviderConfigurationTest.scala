...
import demo.test.reader.mycomponent.MyStreamReaderImpl
import demo.test.transformer.mycomponent.MyStreamTransformerImpl
import demo.test.writer.mycomponent.MyStreamWriterImpl
